...
source_ref: contracts-index-current
owner: architecture
superseded_by: null
...
- `control-loop-v2.md`：Client v2、Node v2 和本地 Runtime 投影边界的权威语义合同；
...
- 当前源码树只提供 Task API v1、Client API v2 和 Node Protocol v2；其它版本、已删除路径和未知字段全部 fail closed。
